...
set LIB_TYP      "$TECH_LIB_PATH/synopsys/u055lsclpmvbpr_120c25_tc.lib"
...
create_library_set -name lib_typ -timing [list $LIB_TYP]
...
create_analysis_view -name av_typ -constraint_mode cmode -delay_corner dc_typ
...
init_design -setup {av_typ} -hold {av_typ}
